...
"firebaseConfig": {
        "apiKey": "AIzaSyCxHCK5mt6BxtxRpdLYqInmrBxVkpok3lM",
        "authDomain": "todo-f94fb.firebaseapp.com",
        "projectId": "todo-f94fb",
        "storageBucket": "todo-f94fb.appspot.com",
        "messagingSenderId": "1092208958585",
        "appId": "1:1092208958585:web:985537ad7419ecc4d348a8",
        "measurementId": "G-5YF0BYD9DP"
      }
...
self.addEventListener('push', event => {
  ...
  if (userDo.targetKind === 'C') {
    ...
    push_url = 'https://todo.hybric.net?source=pwa&targetType=contentsDetail&targetKey=' + targetKey + '&creTeamKey=' + Number(push_data.data.creTeamKey) + '&jobkindId=' + push_data.data.jobkindId
  } else if (userDo.targetKind === 'R') {
    targetKey = userDo.targetKey
    push_url = 'https://todo.hybric.net?source=pwa&targetType=contentsDetail&targetKey=' + targetKey + '&creTeamKey=' + Number(push_data.data.creTeamKey) + '&jobkindId=' + push_data.data.jobkindId
  } else if (userDo.targetKind === 'U') {
    targetKey = userDo.targetKey
    push_url = 'https://todo.hybric.net?source=pwa&targetType=followList'
  } /* else if (userDo.targetKind === 'B') {
    targetKey = userDo.targetKey
    push_url = 'https://todo.hybric.net?targetType=contentsDetail&targetKey=' + userDo.ISub + '&creTeamKey=' + Number(push_data.data.creTeamKey) + '&jobkindId=' + push_data.data.jobkindId
  } */
