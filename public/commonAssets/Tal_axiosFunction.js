...
export async function checkSession () {
  var result = false
  await axios.post('/sUniB/tpcheckSession', { withCredentials: true }
  ).then(response => {
    result = response
  }).catch((error) => {
...
export const methods = {
  ...
  async userLoginCheck (maingoYn) {
    ...
    var result = await axios.post('/sUniB/tploginCheck', Object.fromEntries(paramMap), { withCredentials: true })
  ...
  async saveUserDo (inputParam, type) {
    ...
    var urlSet = null
    if (type === 'delete') { urlSet = '/sUniB/tpdeleteUserDo' } else if (type === 'save') { urlSet = '/sUniB/tpsaveUserDo' }
    param.userKey = store.getters['D_USER/GE_USER'].userKey
    var result = null
  ...
  async changeFollower (inputParam, type) {
    ...
    var urlSet = '/sUniB/tpsaveFollower'
    if (type === 'del') { urlSet = '/sUniB/tpdeleteFollower' } else if (type === 'save') {
