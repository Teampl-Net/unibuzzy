...
self.addEventListener('push', event => {
  ...
  if (userDo.targetKind === 'C') {
    ...
    push_url = 'web+test://http://localhost:8080/#/?source=pwa&targetType=contentsDetail&targetKey=' + targetKey + '&creTeamKey=' + Number(push_data.data.creTeamKey) + '&jobkindId=' + push_data.data.jobkindId
