...
export async function getTeamList (paramMap) {
  var resultList = null
  await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.getUserTeamList', Object.fromEntries(paramMap)
  ).then(response => {
...
export async function getContentsList (inputMap) {
  ...
  var result = null
  await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.getContentsList', Object.fromEntries(paramMap)
  ).then(response => {
...
export async function getContentsList (inputParam) {
  ...
  var result = null
  await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.getContentsList', param
  ).then(response => {
    result = response.data
  }).catch((error) => {
    result = error
...
export async function saveUser (userProfile) {
  ...
  param.user = user
  await axios.post('https://www.unibuzzy.com/sUniB/tp.saveUser', param
  ).then(response => {
    if (response.data === 'OK') {
...
export async function saveUserDo (inputParam) {
  ...
  param.ownUserKey = JSON.parse(localStorage.getItem('sessionUser')).userKey
  var result = null
  await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.saveUserDo', param
  ).then(response => {
    result = response.data
  }).catch((error) => {
    result = error
