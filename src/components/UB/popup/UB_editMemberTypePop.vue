...
<script>
import leftTab from '@/components/popup/memberInfo/memberUnit/D_memTypeLeftTab.vue'
import memberTypeDetail from '@/components/popup/memberInfo/D_memberTypeDetail.vue'
