...
<div class="fl" style="height: 100%; width:100%; position: absolute; left: 0; top: 0; z-index: 999999; background: #fff;">
    ...
    <memberListCompo class="fl" style="padding: 0 1rem; height: calc(80% - 50px); background-color:white; overflow:auto; padding-top: 60px;" :style="'margin-top:' + (this.$STATUS_HEIGHT + 20)+ 'px;'" :propMemberList="memberList" ref="memberListCompo"  :parentSelectList="pList" :selectPopYn="true" @changeSelectMemberList="changeSelectMemberList" :teamInfo="propData" :propData="propData"/>
