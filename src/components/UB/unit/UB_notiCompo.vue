<template>
  ...
  <div @click="this.$emit('clickNoti', mNotiEle)" v-if="mNotiEle.title" style="width: 100%; min-height: 50px; float: left;  margin-bottom: 5px; border-bottom: 1px solid #bbb; background: #FFFFFF; border-radius: 0.8rem; padding: 10px 10px; display: flex; padding-bottom: 5px;">
      ...
      <div style="width: calc(100% - 55px);">
        <!-- <p class="fr font12 fontBold lightGray mbottom-05 textLeft">{{$dayjs(parseCreDate).format('YYYY-MM-DD hh:mm')}}</p> -->
          ...
          <p class="font14 commonBlack textLeft" v-html="mDispMessage"></p>
