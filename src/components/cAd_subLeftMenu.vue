<template>
    <div style="float: left; width: 200px; height: 100%; padding: 1rem 1rem;">
        <!--<img src="../resource/images/icon_folder.png" style="margin-right: 0.5rem; float: left;" alt=""> -->
        ...
        <div class="listRow" style="color: #6768A7;">
            <!-- <img src="../resource/images/icon_folder.png" style="" alt=""> -->
            <img src="../resource/images/allGroupIcon.svg" class="groupIcon" style="width: 0.9rem; margin-right: 0.3rem" alt="">
        ...
        <div class="listRow"  v-if="this.listMode === 'show'" v-for="(value, index) in recvGroupList" :key="index"  @click="selectMenuTab(value.groupKey)">
          <div style="border-bottom: 1px solid #6768A7; float: left; width: 8px; margin-top: 0.8rem; margin-right: 0.4rem;"></div>
            <!--<img src="../resource/images/groupFolderIcon.svg" class="fl groupIcon" alt=""> -->
        ...
        <div v-if="pageType === 'sendPushList'" style="width: 100%;">
          <p style="color:#3A3A3A; font-size: 15px; font-weight: bold; margin-top: 2rem; margin-bottom: 0.5rem; color: rgb(103, 104, 167); cursor:pointer;">임시저장함</p>
          <p style="color:#3A3A3A; font-size: 15px; font-weight: bold; margin-bottom: 1.5rem; color: rgb(103, 104, 167); cursor:pointer;">휴지통</p>
        </div>
