...
<div class="pagePaddingWrap" style="">
  ...
  <div class="textLeft" v-if="this.kind === 'changePhone'">
    <select>
  ...
  <div class="inputWrap">
    <input type="number" placeholder="인증번호 입력" name="" id="" style="">
    </div>
</div>
</template>
...
input{width: 100%; box-sizing: border-box; border:none; padding-right: 80px; height: 40px; line-height: 43px; font-size: 15px; border-bottom: 1px solid #6768A7;}
