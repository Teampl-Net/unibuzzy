...
<style>
.mainHeaderWrap{box-sizing: border-box; display: list-item; background: #F4F7FF!important; padding: 0.5rem 0.7rem; padding-right: 1rem; text-align: left; width: calc(100% + 1px); }
.menuBtn{float: right;}
