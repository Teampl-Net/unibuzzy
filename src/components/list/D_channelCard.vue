  ...
  <template>
      <div class="w100P pSide-1" :style="$appType === 'UB'? 'background-color: rgba(255, 255, 255 ,0.5); border-radius: 10px;':''" style="position: relative; min-height:80px; border-bottom:1px solid #cccccc70; display: flex; flex-direction: row; align-items: center; padding-top: 15px; padding-bottom: 15px;" @click="goChannelMain(chanElement)">
          ...
          <div class="fl mleft-1" style="width: calc(100% - 65px - 1rem);">
              <div class="w100P fl font16 fontBold textLeft grayBlack "><img class="fl img-w14 mtop-02 mright-02" v-if="chanElement.officialYn" src="../../assets/images/main/main_officialMark.svg" alt="">
              ...
              <div class="w100P fl font14 textLeft lightGray">
                  ...
                  <p class="fl font14 " style="margin-top: 1px;">{{chanElement.followerCount !== undefind? chanElement.followerCount:chanElement.fCount}}</p>
              </div>
          </div>
      </div>
  </template>
