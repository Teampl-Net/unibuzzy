<template>
    <div style="width: 100%; height: 100%;">
      ...
      <div v-else class="chanRow w-100P fl channelRow cursorP" v-for="(value, index) in chanList" :key="index" v-on:click="goDetail(value)" >
        <div class="gChanPageChanLogoImgWrap" :class="{ownerChannelRow : value.ownerYn}" :style="'background-image: url(' + value.logoDomainPath + value.logoPathMtext + ');'" style="background-repeat: no-repeat; background-size: cover; background-position: center;">
