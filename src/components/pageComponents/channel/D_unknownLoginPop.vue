<template>
  <div class="fl headerBottom" style="z-index: 101; position: relative; height: 250px; width: 350px; left: calc(50% - 175px); top: calc(50% - 125px); background: white; box-shadow: 0px 7px 9px 9px #00000036; border-radius: 5px;">
    ...
    <div class="popHeader fl textRight w-100P" style="height: 50px; line-height: 50px; padding: 10px;">
    ...
    <div class="popDAlim fl w-100P" style="height: 30px; margin-bottom: 20px; display: flex; align-items: center; justify-content: center;">
      ...
      <div class="font25 headerFont commonColor fl">더알림</div>
    </div>
    <div class="fl w-100P" style="height: calc(100% - 100px);">
      ...
      <div class="fl textLeft font16 textCenter fontBold" style="width: 100%; margin-bottom: 20px; height: 30px; line-height: 30px;">더알림의 알림과 게시글들을 더 구경하고 싶다면?</div>
      <div class="fl w-100P" style="height: calc(100% - 50px); display: flex; align-items: center; justify-content: center;">
        <!-- <div class="fl font22 cursorP CDeepBgColor CDeepColorBorder textCenter fontBold" style="color: white; height: 50px; border-radius: 5px; line-height: 50px; width: 90%;" @click="$router.push({path: 'policies'})">소셜 로그인 하러가기</div> -->
