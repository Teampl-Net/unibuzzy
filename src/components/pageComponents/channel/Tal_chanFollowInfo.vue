...
<div class="zoomInOutPop" style="width: 100%; height: 50%; position:absolute; top:25%; left:0;  z-index:99999; display: flex; flex-direction: column; justify-content: center; align-items: center; ">
    ...
    <div v-if="type==='follow'" class="fadein w-90P greetingTextArea" >
      ...
      <p class="commonBlack font16 fontBold textLeft fl mbottom-1" data-clipboard-action="copy" id="copyTextBody" style="height: 30px; border-bottom: 1px solid black; line-height: 30px;" @click="copyText" :data-clipboard-text="'https://thealim.page.link/?link=https://mo.d-alim.com:9443?chanDetail=' + this.chanInfo.teamKey
      ...
      <div style="width: 100%; min-height: 50px; margin-top: 10px; float: left; display: flex;justify-content: space-evenly;">
        ...
        <!-- <gBtnSmall data-clipboard-action="copy" id="copyTextBody" @click="copyText" class="greetingCopyLinkBtn" :data-clipboard-text="'https://thealim.page.link/?link=https://mo.d-alim.com:9443?chanDetail=' + this.chanInfo.teamKey
