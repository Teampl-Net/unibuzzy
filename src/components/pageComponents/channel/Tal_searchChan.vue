<template>
    <div>
        <div style="position: relative; margin: 1rem 0">
            ...
            <input class="searchInput" ref="channelSearchKey" v-model="message" placeholder="채널 검색하기" />
        </div>
...
.searchInput{border: 2px solid #E4E4E4; width: 100%; border-radius: 12px; padding: 0.4rem; padding-right: 3rem; box-sizing: border-box}
