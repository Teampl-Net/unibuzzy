...
<script>
import manageFollowerList from '../popup/ManageFollowerList.vue'
import editBookListPop from '../popup/EditBookListPop.vue'
import userDetailPop from '../../../popup/UserDetailPop.vue'
import editBoardListPop from '../popup/EditBoardListPop.vue'
import createBoardChannel from '@/components/popup/CreateBoardChannel'
