<template>
  <div style="width: 100%; float: left;">
    <listTitle :propViewTab="this.mViewTab" propListTitle= "채널" :propMoreLink="mMoreLink" class="fl w100P" @openPop="openPop" />
    ...
    <div class="chanTop5Wrap fl" >
      <div class="w100P top5ChannelRow" :style="GE_DISP_CHAN_LIST && index === GE_DISP_CHAN_LIST.length - 1 ? 'border: none!important;' : ''"  v-for="(value, index) in GE_DISP_CHAN_LIST"  :key="index" v-on:click="openPop(value)" >
