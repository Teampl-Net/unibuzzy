<template>
    <div id="commonWrap" class="policyPageWrap" ref="commonWrap">
      ...
      <div id="Parea" v-if="this.policyType === 'personalInfo'" class="policy-02">
            <p class="mbottom-1 font16">개인정보보호법에 따라 더알림에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
            <p class="font16 titleText mbottom-05">1.수집하는 개인정보</p>
            <p class="ml-04 font15 mbottom-05">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 더알림 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 구독, 알림 등 회원 기반의 서비스를 사용하기 위해 회원가입을 할 경우, 더알림은 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
            <p class="subTitle font15 ml-04">회원가입 시점에 더알림이 이용자로부터 수집하는 개인정보는 아래와 같습니다.</p>
            ...
            <p class="mbottom-1 font15 mleft-1">- 회원정보 또는 개별 서비스에서 프로필 정보(별명, 프로필 사진)를 설정할 수 있습니다. 회원정보에 별명을 입력하지 않은 경우에는 마스킹 처리된 아이디가 별명으로 자동 입력됩니다.<br>- 더알림 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
            ...
            <p class="subTitle font15 ml-04">전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다.<br>더알림은 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.</p>
            ...
            <p class="mbottom-1 font15 mleft-1">참고로 더알림은 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.</p>
