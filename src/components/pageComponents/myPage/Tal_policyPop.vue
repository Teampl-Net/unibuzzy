<template>
    <div id="commonWrap" class="policyPageWrap" ref="commonWrap">
        ...
        <div id="Uarea" class="policy-01">
            ...
            <p class="titleText mbottom-05">제 2 조 (용어의 정의)</p>
            ...
            <p class="titleText mbottom-05">제 3 조 (이용약관의 효력 및 변경)</p>
            ...
            <p class="titleText mbottom-05">제 4 조 (약관외 준칙)</p>
            ...
            <p class="titleText mbottom-05">제 5 조 (이용 계약의 성립)</p>
            ...
            <p class="titleText mbottom-05">제 6 조 (서비스 이용 신청)</p>
            <p class="subTitle ml-04"></p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 7 조 (개인정보의 보호 및 사용)</p>
            ...
            <p class="titleText mbottom-05">제 8 조 (이용 신청의 승낙과 제한)</p>
            ...
            <p class="titleText mbottom-05">제 9 조 (회사의 의무)</p>
            <p class="subTitle ml-04"></p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 10 조 (회원의 의무)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 11 조 (서비스 이용 시간)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 12 조 (회원의 알림 등)</p>
            <p class="subTitle ml-04">
            ...
            <p class="titleText mbottom-05">제 13 조 (알림에 대한 저작권)</p>
            <p class="subTitle ml-04">
            ...
            <p class="titleText mbottom-05">제 14 조 (정보의 제공)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 15 조 (광고게재 및 광고주와의 거래)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 16 조 (계약 변경 및 해지)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 17 조 (서비스 이용제한)</p>
            <p class="mbottom-1">
            ...
            <p class="titleText mbottom-05">제 18 조 (손해배상)</p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">제 19 조 (면책조항)</p>
            <p class="subTitle ml-04"></p>
            <p class="mbottom-1 mleft-1">
            ...
            <p class="titleText mbottom-05">부칙</p>
      ...
      <div id="Parea" v-if="this.policyType === 'personalInfo'" class="policy-02">
            ...
            <p class="titleText mbottom-05">2. 수집한 개인정보의 이용</p>
            ...
            <p class="titleText mbottom-05">3. 개인정보의 보관기간</p>
            ...
            <p class="titleText mbottom-05">4. 개인정보 수집 및 이용 동의를 거부할 권리</p>
