  ...
  <template>
  <div
    v-if="this.GE_USER != null && mLoadingShowYn"
    id="loading"
  ...
  <div
    ...
    :style="`padding-bottom: ${this.$STATUS_HEIGHT}px; ${
  ...
  >
    ...
    <div
      class="contentsCardHeaderArea"
      style="width: 100%; min-height: 20px; float: left; padding: 10px 20px"
    >
      <div
        @click="goChannelMain()"
        :style="
          this.GE_USER && this.GE_USER.userKey === CONT_DETAIL.creUserKey
      ...
      >
        ...
        >
          <template
            v-if="
              ...
              this.$checkUserAuth(CONT_DETAIL.shareItem).V === false &&
              this.GE_USER &&
          ...
          <template v-else>
            <p
              ...
              class="cursorDragText textLeft textOverdot commonBlack fontBold font16"
              :class="
                CONT_DETAIL.jobkindId === 'BOAR' &&
        ...
        <div
          style="width: 100%; position: relative; height: 50%; min-height: 25px"
        >
          <div
          ...
          <p class="fr CLDeepGrayColor font12" style="line-height: 23px">
            {{ this.$changeDateFormat(CONT_DETAIL.creDate) }}
          </p>
          <div
            @click="
              openRecvActorListPop(CONT_DETAIL.rUserCount === -1 ? true : '')
            "
            class="fr cursorP font12 commonGrayBG CDeepColor fontBold mtop-02 mright-05"
            v-if="CONT_DETAIL.jobkindId === 'ALIM'"
            :style="
    ...
    <div
      ...
      style="width: 100%; float: left; min-height: 20px"
    >
      <div
        v-if="
          !pUnknownYn &&
      ...
      <div
        v-else
        class="h-400max overHidden fl w-100P"
        :style="!pUnknownYn && pNoAuthYn ? 'height:' : ''"
        ref="contentsBoxRef"
      ...
      >
        <pre
          ...
          class="font14 mbottom-05 mainConts cursorDragText h-100P w-100P fl"
      ...
      <p
        :id="'bodyMore' + CONT_DETAIL.contentsKey"
        class="fr font14 commonColor fontBold mtop-05 mright-1"
        style="display: none"
      >
        {{$t('COMMON_NAME_MORE' + '>')}}
      </p>
    ...
    >
      <template v-for="(value, index) in propPreStickerList" :key="index">
        <gStickerLine
          ...
          :pSelecteModeYn="true"
          :pSmallYn="true"
          @click="this.$emit('selectSticker', value)"
          style="
            cursor: pointer;
            float: left;
            margin-right: 5px;
    ...
    <template
      ...
      v-if="
        ...
        (propJustShowYn &&
          (pNoAuthYn ||
            (CONT_DETAIL.jobkindId === 'BOAR' &&
              this.$checkUserAuth(CONT_DETAIL.shareItem).V === true) ||
            CONT_DETAIL.jobkindId === 'ALIM' ||
            CONT_DETAIL.creUserKey === this.GE_USER.userKey))
      "
    >
      <div
        v-if="pUnknownYn || !pNoAuthYn"
      ...
      >
        ...
        <div
          ...
          v-if="this.CONT_DETAIL.D_CONT_USER_DO !== null || pUnknownYn === true"
        >
          <div
            @click="
              changeAct(
          ...
          >
            <div style="width: 100%; height: 20px; float: left">
              <img
                v-if="
                  !this.CONT_DETAIL.D_CONT_USER_DO[1].doKey ||
          ...
          <div
            ...
            v-if="
              ...
              this.CONT_DETAIL.attachMfilekey > 0
            "
            style="
              cursor: pointer;
              width: 30px;
            ...
            <div style="width: 100%; height: 20px; float: left">
              <img
                v-if="
                  ...
                  this.CONT_DETAIL.attachMfilekey > 0
                "
                src="../../../assets/images/push/contentsClipIcon.svg"
                class=""
                alt=""
              />
              <img
      ...
      >
        ...
        >
          <memoCompo
            ...
            :propContDetail="this.CONT_DETAIL"
            :diplayCount="-1"
            @saveModiMemo="saveModiMemo"
            v-if="this.propDetailYn || mIndex < 3"
        ...
        <p
          v-if="propDetailYn === false && this.mMoreMemoBtnShowYn"
  ...
  <template v-if="mContRecvPopShowYn">
    <div
      @click="this.$refs.recvListPop.closeXPop()"
      style="
        width: calc(100% + 1rem);
        height: 100%;
        top: 0;
  ...
  methods: {
    ...
    setMoreMemoBtn () {
      ...
      for (var i = 0; i < memoList.length; i++) {
        if (this.GE_USER && memoList[i].creUserKey === this.GE_USER.userKey) {
    ...
    async setPreTagInFirstTextLine () {
      ...
      if (
        !window.document.getElementById(
          'bodyFullStr' + this.contentsEle.contentsKey
        )
      ) {
        return
      }
      ...
      var contents = await window.document.getElementById(
        'bodyFullStr' + this.contentsEle.contentsKey
      )
      if (
        !contents ||
    ...
    async setContentsMoreText () {
      ...
      try {
        ...
        if (imgList && imgList.length > 0) {
          for (let i = 0; i < imgList.length; i++) {
            imgList[i].addEventListener('load', (event) => {
              try {
                ...
                var bodyMoreText = window.document.getElementById(
                  'bodyMore' + this.contentsEle.contentsKey
                )
          ...
          var bodyMoreText = await window.document.getElementById(
            'bodyMore' + this.contentsEle.contentsKey
          )
          if (contentHeight > 399) {
            bodyMoreText.style.display = 'block'
    ...
    alimBigView () {
      ...
      var bodyMoreArea = window.document.getElementById(
        'bodyMore' + this.CONT_DETAIL.contentsKey
      )
    ...
    async contentsSharePop () {
      ...
      /*  if (window.navigator.share) {
        window.navigator.share({ title: '모두조인', text: this.CONT_DETAIL.title, url: this.CONT_DETAIL.copyTextStr })
      } else {
    ...
    async changeAct (act, key) {
      if (this.pUnknownYn) {
        this.$showToastPop(this.$t('COMM_MSG_LOGIN'))
        return
      }
