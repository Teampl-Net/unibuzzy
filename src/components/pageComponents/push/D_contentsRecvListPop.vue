                ...
                <template v-else-if="actor.accessKind === 'U'">
                    ...
                    <div class="fl w-100P mleft-05" style="display: flex; align-items: center; " @click.stop="clickEvntToParents('open')">
                        <div class="textLeft fl w-100P " style="" >
                          <p class="fl font16 commonDarkGray fontBold w-100P"><img v-if="actor.userKey === GE_USER.userKey" class="img-w20 mright-03" src="../../../assets/images/editChan/icon_self.svg">{{this.$changeText(actor.userDispMtext)}} <span v-if="initData && initData.jobkindId === 'TODO'">({{ actor.actType === 'RV' ? '담당' : actor.actType === 'CK' ? '검토' : '공개' }})</span></p>
