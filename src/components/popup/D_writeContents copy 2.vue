...
<div style="position: absolute; top:0; left:0; width: 100vw; height: 100vh; min-height: 100vh;">
  ...
  <div class="whitePaper">
      ...
      <div class="fl w-100P h-100P" style="overflow: auto">
        ...
        <div class="fl w-100P mtop-1 " style="display: flex; align-items: center; padding: 0 1.5rem;">
          ...
          <div style="min-height: 2rem; float: left;">
            <checkBtnArea class="mleft-05 mtop-05" title='실명' :selectedYn='showCreNameYn' @click="showCreNameYn = !showCreNameYn" />
            <checkBtnArea class="mleft-05 mtop-05" title='댓글' :selectedYn='canReplyYn' @click="canReplyYn = !canReplyYn" />
            <checkBtnArea class="mleft-05 mtop-05" title='제목' :selectedYn='titleShowYn' @click="titleShowYn = !titleShowYn" />
          </div>
        </div>
      ...
      <gBtnSmall class="font20 " style="position: absolute; bottom: -8%; left:50%; transform: translateX(-50%); border: 2px solid #FFFFFF; width: 120px; line-height: 35px !important; height: 35px; font-size:16px"  :btnTitle="requestPushYn === false ? '발송하기' : '신청하기'" @click="clickPageTopBtn()" />
  </div>
