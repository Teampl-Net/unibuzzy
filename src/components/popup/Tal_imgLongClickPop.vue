  ...
  <div style="width: 100%; float: left;">
    ...
    <div class="imgAlertWrap" style="margin: 1rem 0rem;">
      <div class="fl " style="width: 100%; background:#ffffff; border-radius:10px; min-height:50px; display: flex; justify-content: center; align-items: center; flex-direction: column;">
        <p class="fl font16 w100P commonColor" style="min-height:50px; line-height:50px; " @click="emit({type: 'clickBtn', option: 'download'})">다운로드</p>
        <!-- <p class="fl font16 w100P commonColor " style="min-height:50px; line-height:50px; border-top: 1px solid #eee;" @click="this.$emit('clickBtn', 'share')">공유하기</p> -->
        <p class="fl font16 w100P commonColor " style="min-height:50px; line-height:50px; border-top: 1px solid #eee;" @click="emit({type: 'clickBtn', option: 'preview'})">자세히</p>
