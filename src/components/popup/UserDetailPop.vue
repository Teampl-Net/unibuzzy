<template>
  <div id="addTeamMemberArea" class="addTeamMemberArea">
    ...
    <div class="profileImgWrap w100P fl mbottom-1">
      ...
      <div v-if="selfYn" @click="changeUserImg()" class="font14 selfImg">
        Change
      </div>
    </div>
    <div class="addMemberTextArea fl">
      <div class="fl w100P dispContents">
        ...
        <div v-show="changeYn" class="fl creChanInput" style="">
          ...
          <div class="fl" style="width: 100px">
            ...
            <p class="fl mleft-1 font13 lineHeight30" @click="changeYn = false">
              Cancel
            </p>
          </div>
        </div>
      ...
      <div class="mtop-1 fl w100P infoBox">
        <img
          ...
          alt=""
        />
        <p class="fl font16 commonDarkGray creChanInput" v-if="readOnlyYn">
          {{ memEmail ? memEmail : $t('COMMON_MSG_NO_EMAIL') }}
        </p>
        <input
          v-else
          type="text"
      ...
      <div class="mtop-1 fl w100P infoBox">
        ...
        />
        <p class="fl font16 commonDarkGray creChanInput" v-if="readOnlyYn">
          {{ memPhone ? memPhone : $t('COMMON_MSG_NO_PHONE') }}
        </p>
        <input
          v-else
          type="text"
      ...
      <gBtnSmall
        ...
        btnTitle="추가"
        class="fl"
        style="position: absolute; bottom: 0; right: 3rem"
        @click="addDirectAddMemList"
      />
      <div
        v-if="readOnlyYn"
        class="fl w100P mtop-3"
        style="
          min-height: 70px;
          display: flex;
          flex-direction: row;
          ...
          <div class="flexAlignCenter flexColumn">
            <div class="nativeServiceBtnWrap">
              <img
                ...
                :class="{ noData: memEamil === $t('COMMON_MSG_NO_EMAIL') }"
                src="@/assets/images/editChan/icon_letter.svg"
                class="img-w20"
                alt=""
              />
              <img
                ...
                :class="{ noData: memPhone === $t('COMMON_MSG_NO_PHONE') }"
                src="@/assets/images/editChan/icon_phoneSolid.svg"
                class="img-w20"
                alt=""
              />
            ...
            <p class="font14 fl textLeft commonBlack lineHeight30">
              {{ value.funcTitle }}
            </p>
          </div>
        </div>
...
export default {
  ...
  async created() {
    ...
    if (
      ...
      if (this.mUserInfo.userEmail) this.memEmail = this.mUserInfo.userEmail
      else {
        this.memEmail = this.$t('COMMON_MSG_NO_EMAIL')
      }
      if (this.mUserInfo.userDispMtext)
        this.memName = this.$changeText(this.mUserInfo.userDispMtext)
      if (this.mUserInfo.phoneEnc) this.memPhone = this.mUserInfo.phoneEnc
      else {
        this.memPhone = this.$t('COMMON_MSG_NO_PHONE')
      }
