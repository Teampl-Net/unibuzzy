  ...
  <div id="addTeamMemberArea" class="addTeamMemberArea">
    ...
    <div class="profileImgWrap w100P fl mbottom-1">
        <div class="profileImgBox" :style="'width: ' + popSize*0.3 + 'px; height: ' + popSize*0.3 + 'px;'">
            <div :style="'background-image: url(' + (mUserInfo.domainPath ? mUserInfo.domainPath + $changeUrlBackslash(mUserInfo.userProfileImg) : mUserInfo.userProfileImg) + '); width: ' + popSize*0.3 + 'px; height: ' + popSize*0.3 + 'px;'" class="userProfileImgWrap">
