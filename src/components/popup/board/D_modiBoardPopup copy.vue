...
<selectBookList     :chanInfo="this.CHANNEL_DETAIL" :propData="this.chanProps" :boardDetail="this.boardDetail" :chanAlimListTeamKey="this.modiBoardDetailProps.teamKey" :pSelectedList="selectedList" :selectPopYn='true'
@sendReceivers='setSelectedList' @openPop='openPop' v-if="selectBookListShowYn" @closeXPop='selectBookListShowYn = false' />

<receiverAccessList :chanInfo="this.CHANNEL_DETAIL" :propData="this.chanProps" :boardDetail="this.boardDetail" :baseList='selectedList.data' :pSelectedList='permissionSelectedList' :selectPopYn='true'
@sendReceivers='receiverPoolInSetting' v-if="receiverAccessListYn" @closeXPop='receiverAccessListYn=false'/>
