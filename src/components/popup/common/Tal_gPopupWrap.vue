  ...
  methods: {
    ...
    async goDetail (detailValue) {
      ...
      if (detailValue.chanYn) {
        ...
        if (indexOf !== -1) {
          if (this.propParams.targetKey === detailValue.targetKey) {
            return
          }
        }
