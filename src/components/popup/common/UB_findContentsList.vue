...
<!-- <subHeader class="headerShadow" :headerTitle="this.headerTitle" :subTitlebtnList= "this.subTitlebtnList" @subHeaderEvent="subHeaderEvent"></subHeader> -->
  <div id="findContPop" class="pagePaddingWrap findPopupWrap" :style="'padding-top:' + (this.$STATUS_HEIGHT + 50 )+ 'px'" >
    <gPopHeader class="popHeaderShadow" v-if="(contentsListTargetType === 'boardMain')" :headerTitle="$t('SEAR_TITLE_POST')" :pClosePop="pClosePop" @closeXPop="closeXPop"/>
    <gPopHeader class="popHeaderShadow" v-else-if="(contentsListTargetType === 'myActList')" headerTitle="나의 활동 검색" :pClosePop="pClosePop" @closeXPop="closeXPop"/>
    <gPopHeader class="popHeaderShadow" v-else-if="(contentsListTargetType === 'fileBox')" :headerTitle="$t('SEAR_TITLE_FILE')" :pClosePop="pClosePop" @closeXPop="closeXPop"/>
    <gPopHeader class="popHeaderShadow" v-else :headerTitle="$t('SEAR_TITLE_CONTENTS')" @closeXPop="closeXPop" :pClosePop="pClosePop"/>
