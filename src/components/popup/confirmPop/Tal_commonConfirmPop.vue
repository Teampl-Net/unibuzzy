...
<style scoped>
.confirmPopWrap{width: 350px; position: fixed; z-index: 99999; top: 30%; min-height: 220px;box-shadow: 0 0 9px 2px #b8b8b8; max-height: 500px; max-height: 250px; border-radius: 10px; background: #FFFFFF;}
