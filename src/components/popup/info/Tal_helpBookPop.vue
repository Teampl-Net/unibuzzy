...
<style>
.bookPopText {z-index: 999; top: 0; background-color: white; position: fixed; overflow: hidden scroll; margin: 10px; border-radius: 10px; padding: 15px; min-height: 300px; max-height: 70%;}
