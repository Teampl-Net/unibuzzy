...
※ 상세한 내용은 사이트 내 개인정보 취급방침을 참고 해 주세요.
    ...
    <div class="guideBox">
      <!-- <p class= "mtop-1" >모두조인 개인정보 삭제 방침 안내</p> -->
      <p class= "mtop-1" >모두조인 개인정보 이용약관</p>
...
import leaveResultPop from './Tal_leaveTheAlimResultPop.vue'
export default {
  data () {
    return {
