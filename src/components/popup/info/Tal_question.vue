<i18n>
  ...
  "ko": {
    ...
    "COMM_ANSWER_THREE": "모두조인 하단 메뉴 우측 내정보 > 프로필 카드를 클릭하면 나오는 설정페이지에서 자유롭게 정보를 수정해봐요!",
    "COMM_ANSWER_FOUR" : "모두조인은 소셜로그인을 통해 들어오게 되기 때문에 개인 정보는 모두조인이 아닌 해당 소셜의 정책에 따라 보호받게 됩니다.",
    "COMM_BTN_MOVE": "바로가기",
  },
  "en": {
...
<div class="pagePaddingWrap" style="overflow: hidden scroll !important;" >
  <div class="qPageWrap">
    <div class="qPageHeaderTextWrap ">
      ...
      <p class="font16 fontBold grayBlack fl w-100P commonBlack" style="height: 30px; line-height: 30px;">모두조인 채널으로 이동하여 편하게 질문하고 소통해보세요!</p>
    </div>
