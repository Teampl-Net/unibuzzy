...
<div class="w-100P h-100P" style="position: absolute; top: 0; padding: 60px 1rem 0 1rem; ">
    ...
    <div class="pageTopAreaStyle">
        <div class="tableTopArea">
            ...
            <p class="font14  fontBold fl" style="width: 125px;">관리자</p>
        </div>
        ...
        <gBtnSmall @click="openReceptListPop" btnTitle="등업신청목록" class="receptListBtnStyle cursorP"/>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getFollowerList () {
      ...
      if (this.searchFilterObj.userDispMtext != null) {
        paramMap.set('userDispMtext', this.searchFilterObj.userDispMtext)
      }
      if (this.searchFilterObj.phoneEnc != null) {
        paramMap.set('phoneEnc', this.searchFilterObj.phoneEnc)
      }
      if (this.searchFilterObj.userEmail != null) {
    ...
    async saveManager (follower) {
      ...
      var result = await this.$commonAxiosFunction({
        url: 'https://mo.d-alim.com/service/tp.saveManager',
        param: param
      })
      console.log(result)
      debugger
