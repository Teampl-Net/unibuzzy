<template>
<div class="fl w-100P" style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
  ...
  <template v-if="propData.InfoQueType === 'mu'">
  </template>
...
export default {
  ...
  created () {
    if (this.propData.InfoQueType === 'si') {
