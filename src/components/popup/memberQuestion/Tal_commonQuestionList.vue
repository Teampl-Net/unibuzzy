<template>
    <draggable @end="changePosTeamMenu" handle=".draggablePointer" class="ghostClass" v-model="questionList" ghost-class="ghost" style="padding-top: 10px; --webkit-tap-highlight-color: rgba(0,0,0,0);" :disabled='enabled' delay="200"  >
      <transition-group>
        <div v-for="(data, index) in questionList" :key="index" class="fl w100P mtop-05 mbottom-05 mQuestionCard" >
          ...
          <div style="width:calc(100% - 30px);" class="fr">
            ...
            <div class="questionMiddleArea">
              ...
              <div v-if="data.questionType === 'si' || data.questionType === 'mu'" class="w100P fl mtop-05 textLeft" >
                <div v-for="(answer, answerindex) in data.answerList" :key="answerindex" class="fl w100P" style="display: flex; align-items: center; padding-bottom:0.5rem">
