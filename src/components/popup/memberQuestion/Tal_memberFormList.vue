...
export default {
  ...
  data () {
    return {
      ...
      creFormYn: false,
      findPopShowYn: false,
      // dummyData: [{ mFormKey: 1, mFormTitle: '하이브릭 멤버신청', mFormMemo: '하이브릭 멤버활동에 필요한 필수 정보입니다!', activeYn: true, creDate: '2022-08-04 15:00' },
      //   { mFormKey: 2, mFormTitle: '하이브릭 멤버신청(임시)', mFormMemo: '하이브릭 멤버활동에 필요한 필수 정보입니다!', activeYn: false, creDate: '2022-05-04 15:00' },
      //   { mFormKey: 3, mFormTitle: '멤버신청(임시)', mFormMemo: '하이브릭 멤버활동에 필요한 ', activeYn: false, creDate: '2021-12-04 15:00' }],
      // dummyData: [{ mFormKey: 1, mFormTitle: '하이브릭 멤버신청', mFormMemo: '하이브릭 멤버활동에 필요한 필수 정보입니다!', activeYn: true, creDate: '2022-08-04 15:00', questionList: [{ questionTitle: '질문제목', questionType: 'su' }, { questionTitle: '질문제목', questionType: 'si', answerList: [{ answerName: '답안' }] }, { questionTitle: '질문제목', questionType: 'mu', answerList: [{ answerName: '답안' }] }, { questionTitle: '질문제목', questionType: 'at' }] }],
      dummyData: [{ mFormKey: 1, mFormTitle: '하이브릭 멤버신청', mFormMemo: '하이브릭 멤버활동에 필요한 필수 정보입니다!', activeYn: true, creDate: '2022-08-04 15:00', questionList: [{ questionKey: 0, questionTitle: '질문제목', questionType: 'su', essentialYn: true }, { questionKey: 1, questionTitle: '질문제목', questionType: 'si', essentialYn: true, answerList: [{ answerName: '답안' }] }, { questionKey: 2, questionTitle: '질문제목', essentialYn: true, questionType: 'mu', answerList: [{ answerName: '답안' }] }, { questionKey: 3, questionTitle: '질문제목', essentialYn: true, questionType: 'at' }] },
  ...
  methods: {
    getChanMemberForm () {
      ...
      //   url : 'https://www.hybric.net:9443/service/tp.getChanMemberForm',
      //   param: param
      // })
