...
export default {
  ...
  methods: {
    getMemberForm () {
      ...
      //   url : 'https://mo.d-alim.com:9443/service/tp.getMQuestion',
      //   param: param
      // })
