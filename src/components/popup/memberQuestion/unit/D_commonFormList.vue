<template>
  <div v-for="(data, index) in propFormList" :key="index" class="fl w100P mtop-05" style="border-bottom:1px solid #ccc;padding-bottom:0.5rem">
    ...
    <p @click='goFormDetail(data)' class="fl lightGray textLeft font16 w100P textOverdot">{{data.mFormMemo}}</p>
