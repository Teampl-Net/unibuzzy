...
<div style="width: 100%; float: left;">
  ...
  <div class="formMenuList" style="">
    <div @click="buttonEvent(data.buttonEvent)" v-for="(data, index) in mButtonList" :key="index" class="fl w100P" style="min-height: 40px; padding: 0.5rem 1rem;" :style="index !== (mButtonList.length-1) ? 'border-bottom: 1px solid #ccc;' : '' " >
