<template>
    ...
    <div style="width: calc(100% ; border-radius: 15px 15px 0 0; left: 0px; min-height: 80px; padding: 15px 10px; box-shadow: 0 0 9px 4px #00000036; position: absolute; z-index: 9999; bottom: 0; background: #fff;">
