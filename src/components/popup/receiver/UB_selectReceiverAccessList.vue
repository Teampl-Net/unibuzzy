    ...
    <div class="w100P pagePaddingWrap accessPopBody" :style="'padding-top:' + (this.$STATUS_HEIGHT + 60)+ 'px'">
      <div>
        ...
        <transition name="showGroup">
            ...
            <gBookMemberList :listData="memberList" :propMemberList="memberList" :parentSelectList="selectList.memberList" :selectPopYn="true" @changeSelectMemberList="changeSelectMemberList" :teamInfo="propData" :propData="this.propData" class="memberListStyle" transition="showGroup" ref="memberListCompo" v-if="detailOpenYn" />
        </transition>
      </div>
...
<script>
/* eslint-disable */
import selectBookNMemberList from './UB_selectBookAndMemberList.vue'
