<template>
  <div class="fl cursorP commonColorBorder" style="border-radius: 7px; min-width: 80px; padding:3px 7px;  padding-right: 25px; position: relative;">
    <p class="fl font12 lightGray"><small class="fl font12 commonColor fontBold mleft-03">title</small><small class="fl font12 fontBold lightGray mleft-03">{{propSearchBox.dispName}}</small></p>
