...
<template>
    ...
    <div v-if="false" ref="toolBoxRef" style="position: absolute !important; bottom: 0; left: 0; border: 1px solid #ccc; ;width: calc(100%); height: 40px;box-shadow: rgb(130 130 153 / 39%) 0px 6px 9px -5px; padding: 5px 10px;z-index: 999999; background: #FFFFFF;">
      <div class="fl h-100P " style="width: 25%;">
        <p style=" color: rgb(74 102 158); float: left; line-height: 35px; margin-right: 5px; font-size: 18px; width: 100%; " @mousedown="toolBoxShowYn? clickSelectBox():''">{{ $t('FORM_TITLE_FONT') }} {{this.tools.ftSize}}</p>
        <div v-if="fontSelectBoxShowYn && toolBoxShowYn" style="width: 25%; position: absolute; background: #fff; min-height: 80px; left: 2px; top: -90px; border: 1px solid #ccc; border-bottom: none;">
          <div @mousedown="changeFontSize(20)" style="font-size: 20px; height: 30px;  color: rgb(74 102 158);" value="20">{{ $t('FORM_BTN_BIG') }}</div>
          <div @mousedown="changeFontSize(16)" style="font-size: 16px; height: 30px; color: rgb(74 102 158);" value="16">{{ $t('FORM_BTN_MID') }}</div>
          <div @mousedown="changeFontSize(12)" style="font-size: 12px; height: 30px; color: rgb(74 102 158);" value="12">{{ $t('FORM_BTN_SMALL') }}</div>
        </div>
      </div>
    ...
    <!-- v-if="toolBoxShowYn" -->
      <!-- <div ref="eContentsWrap" id="eContentsWrap" style="width: 100%; height: calc(100%); min-height: 300px; border: 1px solid rgb(74 102 158)45; border-radius: 5px; overflow-x: hidden; background: #ffffff; position: relative; ">
      ...
      <div ref="eContentsWrap" id="eContentsWrap" class="fl" style="width: 100%; min-height: 250px; border-radius: 10px; background: #ffffff; position: relative;     margin-bottom: 10rem;">
          <div class="fl" style="width: 100%; height: 100%; height: 100%;">
              <draggable id="dragCompp"  ref="editableArea" class="ghostClass" :v-model="formCardList" ghost-class="ghost" :dragging="dragging" @choose='test' @end="changePosTeamMenu" delay="200" handle=".movePoint">
                  <transition-group>
                      ...
                      <!-- A9AACD -->
                      <div v-for="(value, index) in formCardList" :index="index" :class="value.type === 'text' ? 'formCardBackground': 'formLineCard'" :style="this.selectRow === value.targetKey? 'border: 1px solid rgb(172 197 247);':''" style="position: relative; border-radius:10px;" :key="value.targetKey" :id="'formCard'+value.targetKey" class="fl formDiv commonFormCard" @click="clickForm(value, value.targetKey)">
                        ...
                        <div @click="moveClick(value, value.type)" class="movePoint" style="position: absolute; width: 30px; height: 100%; display: flex; right: 0px; top: 0; border-radius:0 10px 10px 0; align-items: center; justify-content: start; flex-shrink: 0; flex-grow: 0;background: rgba(255, 255, 255, 0.75); "><img src="../../../assets/images/formEditor/icon_formEdit_movePointer.svg" class="img-w15" style="flex-shrink: 0; flex-grow: 0" alt=""></div>
              ...
              <div class="mtop-1 fl w-100P" style="width: 100%; min-height: 100px; display: flex;justify-content: flex-start; flex-direction: column;align-items: center; ">
                ...
                <!-- <div @click="this.plusBtnShowYn = false" v-if="plusBtnShowYn" style=" float: left; width: 100%; display: flex; background-color: #879dc9; align-items: center; justify-content: center; border-radius: 3px; box-shadow: rgb(191 191 218) 0px 0px 2px 0px; ">+</div> -->
                <div v-else-if="this.plusBtnShowYn === false" class="plusCardBtn CWhitePurpleBgColor CLightPurpleBorderColor" style="width:100%; padding:6px 10px; display: flex;  float: left; align-items: center; justify-content: center; margin: 0 auto; min-height: 40px; background: #ccc; border-radius: 8px; margin-top: 0.5rem">
                    <div @click="addFormCard('text')"  class="CLightPurpleBorderColor" style="width: calc(100% - 2.5px); background: #FFF; border-radius: 3px; box-shadow: rgb(191 191 218) 0px 0px 2px 0px; height: 100%; margin-right: 5px; display: flex; justify-content: center; align-items: center; border-right: rgb(74 102 158);"><img class="fl" src="../../../assets/images/formEditor/addText.svg" alt=""></div>
                    ...
                    <div @click="this.showBlockTypeYn = !this.showBlockTypeYn"  class="CLightPurpleBorderColor" style="width: calc(100% - 2.5px); background: #FFF; border-radius: 3px; box-shadow: rgb(191 191 218) 0px 0px 2px 0px; height: 100%; margin-right: 5px; display: flex; justify-content: center; align-items: center; border-right: rgb(74 102 158);"><img class="fl" src="../../../assets/images/formEditor/borderIcon.svg" alt=""></div>
