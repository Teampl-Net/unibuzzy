<template>
  <pre @focus="test" placeholder="내용을 입력해주세요." contenteditable style="padding: 0 20px; display:inline-block; width: calc(100% - 30px); border-right: #ccc; word-break: break-all;" autofocus :formIdx="targetKey"  ref="formTextArea" :id="'formTextArea'+targetKey" class="formCard formText editableContent formCardTextid" @input="inputResize('formTextArea'+targetKey)"></pre>
