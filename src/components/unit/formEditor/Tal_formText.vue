<template>
        <span style="padding: 0 5px; display:inline-block;width: calc(100% - 30px); border-right: #ccc;" :formIdx="targetKey" @focus="this.$emit('showToolBox', {tools: tools})" ref="formTextArea" :id="'formTextArea'+targetKey" class="formCard formText" @input="inputResize('formTextArea'+targetKey)"></span>
