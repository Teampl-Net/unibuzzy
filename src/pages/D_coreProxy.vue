...
export default {
  ...
  methods: {
    ...
    async openDirectBoard () {
      ...
      const result = await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.getDirectBoardInfo', this.mRecvParams)
      console.log(result)
      this.mAxiosYn = false
      /* var result = await commonAxiosFunction({
          url: 'https://www.unibuzzy.com/sUniB/tp.goDirectBoard',
    ...
    async saveUserAccess () {
      ...
      console.log(this.mRecvParams)
      var result = await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.saveUserAccess', setParam)
      this.mAxiosYn = false
      if (result.data.result) {
        return 'OK'
      }
    ...
    async saveUserAndAccess (userProfile) {
      ...
      // var result = await this.$axios.post('https://www.unibuzzy.com/sUniB/tp.saveUserAndAccess', setParam)
      // this.mAxiosYn = false
    },
