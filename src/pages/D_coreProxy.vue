...
export default {
  ...
  methods: {
    ...
    async openDirectBoard () {
      ...
      const result = await this.$axios.post('https://www.hybric.net:9443/service/tp.getDirectBoardInfo', this.mRecvParams)
      console.log(result)
      this.mAxiosYn = false
      /* var result = await commonAxiosFunction({
          url: 'https://www.hybric.net:9443/service/tp.goDirectBoard',
    ...
    async saveUserAccess () {
      ...
      console.log(this.mRecvParams)
      var result = await this.$axios.post('https://www.hybric.net:9443/service/tp.saveUserAccess', setParam)
      this.mAxiosYn = false
      if (result.data.result) {
        return 'OK'
      }
    ...
    async saveUserAndAccess (userProfile) {
      ...
      // var result = await this.$axios.post('https://www.hybric.net:9443/service/tp.saveUserAndAccess', setParam)
      // this.mAxiosYn = false
    },
