<template>
  <div class="pagePaddingWrap nonMemBoardWrap">
    ...
    <div v-if="infoShowYn" class="zoomInOutPop" style="width: 80%; padding: 10px 20px; margin: 0 auto; height: 80%; max-height: 550px; min-height: 300px; background: #ffff; position: absolute; top: 10%; left: 10%; border-radius: 15px; z-index: 9999;">
      ...
      <p class="font18 mbottom-05 fontBold textLeft">모두조인 비회원 문의 안내</p>
      <p class="font15 fontBold commonBlack textLeft">1. 모두조인 계정이 있으신가요?</p>
      <p class="font14 mbottom-05 mleft-1 textLeft commonBlack">1) 모두조인 채널 > 문의게시판 <br>2) 메뉴 > 문의하기를 통해 문의해주세요!</p>
      ...
      <p class="font14 commonBlack mleft-1 textLeft">
        ...
        <br> 2) [문의]모두조인에 대해 궁금한점이 있는 경우
        <br> 3) [개선]모두조인팀에게 개선점을 제시하고 싶은 경우
        <br> 4) [메세지]모두조인팀에게 응원/후기 등을 전달하고 싶은경우
      </p>
...
export default {
  ...
  methods: {
    ...
    openWriteBoard () {
      ...
      params.targetNameMtext = 'KO$^$모두조인'
