...
<template>
    <div style="float: left; width: 100%; height: 100%; overflow: hidden;" :style="this.$route.path === '/chanList'? 'margin-top:' + (this.$STATUS_HEIGHT + 50)+ 'px; padding-bottom: 80px;':''">
        <div style="width: 100%; height: 100%;  float: left; background: #fff; position: relative;">
            ...
            <div style="position: absolute; width: 50px; height: 50px; border-radius: 100%; background: #879dc9d1; padding: 10px;  right: calc(10% + 7px);" :style="'bottom:' + (this.$STATUS_HEIGHT + 150)+ 'px'"  @click="refreshList">
...
export default {
  ...
  methods: {
    ...
    async changeSearchList (idx) {
      console.log('this.mResultSearchKeyList', this.mResultSearchKeyList)
