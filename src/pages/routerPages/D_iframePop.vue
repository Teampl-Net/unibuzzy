    ...
    async getTodoList (searchFromDate, searchToDate) {
      ...
      if (myContents.data) {
        ...
        if (this.iframeDom && this.iframeDom.contentWindow && this.iframeDom.contentWindow.postMessage) {
          this.iframeDom.contentWindow.postMessage(JSON.stringify({ sender: 'D', type: 'initData', listViewUrl: `https://mo.d-alim.com/#/view/:date/TODO/${this.GE_USER.userKey}`, data: this.calDataList }), '*')
        }
      }
    },
    splitList (todoList) {
