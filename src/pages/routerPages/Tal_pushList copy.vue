...
.pushListSearchArea{position: relative; margin: 1rem 0; min-height: 2.5rem; width: 100%; float: left;}
...
.stickerWrap{width: 100%; height: 70px; overflow-x: scroll; overflow-y: hidden;}
.stickerFrame{min-width: 100%;  width: var(--stickerDivWidth); height: 50px;}
</style>
