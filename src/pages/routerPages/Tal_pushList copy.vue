      ...
      try {
        ...
        if (result.data.result === true || result.data.result === 'true') {
          ...
          if (memoLength !== undefined && memoLength !== null && memoLength !== '') {
            var response = await this.getContentsMemoList(this.currentContentsKey, 0, 0)
            console.log('###########################################')
            ...
            // if (this.viewMainTab === 'P') {
            //   if (idx !== -1) {
            //     // var temp = this.alimContentsList.splice(idx, 1)
            //     // alert(idx)
            //     // console.log('33333333333333333')
            //     // console.log(temp)
            //     // this.alimContentsList[idx].D_MEMO_LIST = []
            //     // this.$refs.pushListChangeTabLoadingComp.memoReload()
            //     this.alimContentsList[idx].D_MEMO_LIST = cont.D_MEMO_LIST
            //     // this.alimContentsList.splice(idx, 0, temp)
            //   } else {
            //     this.$showToastPop('에러코드 -M/S/P-A-idxErro')
            //   }
            // } else if (this.viewMainTab === 'B') {
            ...
            //     this.boardContentsList[idx].D_MEMO_LIST = cont.D_MEMO_LIST
            //     this.$refs.pushListChangeTabLoadingComp.memoReload()
            //   } else {
            //     this.$showToastPop('에러코드 -M/S/P-idxErro')
            //   }
